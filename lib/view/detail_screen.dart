...
import 'package:master_app/view/widgets/detail_controller.dart';
...
class _DetailScreenState extends State<DetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        color: Color.fromARGB(255, 203, 248, 223),
        child: Stack(
          children: [
            Positioned(
                top: 50,
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      CircleAvatar(
                        radius: 40,
                        backgroundImage: AssetImage(Get.arguments['image']),
                      ),
                      SizedBox(
                        width: 10,
                      ),
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: AssetImage(image[i]['image']),
                            fit: BoxFit.cover)),
                  ),
                )
            ]),
